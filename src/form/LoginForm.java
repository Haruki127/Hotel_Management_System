...
public class LoginForm {
	...
	private void initialize() {
		...
		lblHotelRiza.setBounds(91, 177, 108, 35);
		...
		lblPhAddr.setBounds(0, 210, 290, 37);
		panel.add(lblPhAddr);
		...
		lblSince.setBounds(103, 286, 84, 14);
		panel.add(lblSince);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(LoginForm.class.getResource("/images/logo.png")));
		lblNewLabel.setBounds(46, 38, 140, 96);
		...
		frmLogin.getContentPane().add(lbl_close);
				...
				lblLoginForm.setFont(new Font("Tahoma", Font.BOLD, 15));
						...
						lblNewLabel_1_1.setBounds(324, 189, 102, 14);
						...
						lblNewLabel_1_1.setFont(new Font("Century Gothic", Font.PLAIN, 13));
								...
								txtEmail.setColumns(10);
										...
										lblPassword.setFont(new Font("Century Gothic", Font.PLAIN, 13));
												...
												pwfPassword.setBounds(436, 257, 227, 29);
												...
												pwfPassword.setBorder(new MatteBorder(0, 0, 1, 0, (Color) new Color(187, 129, 62)));
														...
														btnLogin.setBounds(324, 383, 118, 23);
														...
														btnLogin.setBackground(new Color(187, 129, 62));
																...
																lblForgotYourPassword.setBounds(549, 330, 114, 14);
																frmLogin.getContentPane().add(lblForgotYourPassword);
																lblForgotYourPassword.setFont(new Font("Tahoma", Font.PLAIN, 10));
																lblForgotYourPassword.setForeground(new Color(187, 129, 62));
																
																		JButton btnCreateAccount = new JButton("Create Account");
																		btnCreateAccount.setBounds(545, 383, 118, 23);
																		frmLogin.getContentPane().add(btnCreateAccount);
																		btnCreateAccount.setFont(new Font("Tahoma", Font.PLAIN, 10));
																		btnCreateAccount.setForeground(new Color(187, 129, 62));
